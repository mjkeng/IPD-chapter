...
For illustration purposes, we will therefore additionally adjust the cost model for baseline age and gender, and utilities model for baseline age, gender and utility at baseline. This can be done using the same `lm` syntax, but with relevant independent predictors added to the right-hand side of the formula:
